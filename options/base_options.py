...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='TrainingHalfBS2Epoch100DataX10UnetLoss3Dsynchbach', help='name of the experiment. It decides where to store samples and models')
