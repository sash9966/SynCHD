...
if __name__ == '__main__':
    input_folder = "/scratch/users/fwkong/SharedData/imageCHDCleanedOriginal_aligned_all/aligned/normed_img"  # Replace with the path to your folder containing original NIfTI files
    output_folder = "/scratch/users/fwkong/SharedData/imageCHDCleanedOriginal_aligned_all/aligned/normed_img128"  # Replace with the path where you want to save the resized NIfTI files
