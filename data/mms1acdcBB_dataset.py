    ...
    def modify_commandline_options(parser, is_train):
       ...
       #For testing
        ...
        parser.add_argument('--label_dir', type=str, required=False, default = "/scratch/users/fwkong/SharedData/imageCHDCleanedOriginal_aligned_all/aligned/normed_img128",
                            help='path to the directory that contains label images')
        parser.add_argument('--image_dir', type=str, required=False, default ="/scratch/users/fwkong/SharedData/imageCHDCleanedOriginal_aligned_all/aligned/seg_nii_gz_only_128",
                            help='path to the directory that contains photo images')
